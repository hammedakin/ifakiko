...
const Principles = () => {
      ...
      return (
            ...
            <section className="bg-white pb-4 font-josefin-sans">
                  <div className="relative space-y-4 mx-auto max-w-7xl">
                        {principles.map((item, index) => {
                              return (
                                    <div
                                          data-aos={item.animate}
                                          key={index}
                                          className={`flex  flex-col  items-center md:justify-between
                                                gap-4`}
                                    >
